...
<head>
    ...
    <script type="text/javascript"
            src="http://api.map.baidu.com/api?v=2.0&ak=5uShx4zfqyMuj4WvhPC5PiYMPOvUcLpZ"></script>
</head>
<body>
<form action="" method="get">
    ...
    <div style="width:1000px;height:600px;border:1px solid gray" id="container"></div>
...
<script type="text/javascript">
    ...
    //创建点坐标
    var point = new BMap.Point(113.279719, 23.10159);
    //初始化地图，设置中心点坐标和地图级别
