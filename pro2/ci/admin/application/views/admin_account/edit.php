...
//            },
            ...
            ajax: {
                url: '<?php echo site_url("admin_account/admin_account/getAccounts")?>',
                dataType: "json",
        ...
        <form action="" id="form">
            <div class="form-group">
                ...
                <input id="project_id" name="project_id" type="text"
                       value='<?php echo isset($editing['project_id']) ? $editing['project_id'] : "1"; ?>'
                       placeholder="项目ID"/>
                <input id="id" type="hidden" name="id"
                       value="<?php echo isset($editing['id']) ? $editing['id'] : ""; ?>">
            </div>
...
<script>
    $('#sub').click(function () {
        ...
        $.ajax({
            url: '<?php echo site_url("admin_account/admin_account/save")?>',
            type: 'post',
            data: form,
            processData: false,
            contentType: false,
