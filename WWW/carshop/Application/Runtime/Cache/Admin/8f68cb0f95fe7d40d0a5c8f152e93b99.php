 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Privilege/lst.html">权限管理</a><span class="crumb-step">&gt;</span><span>新增权限</span></div>
        </div>
                            ...
                            <td>
                                <select name="parentid" id="catid" class="required">
                                    <option value="0">顶级权限</option>
                                     <?php if(is_array($prires)): foreach($prires as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["pri_name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
