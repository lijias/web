...
<!--
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Admin/lst.html">管理员管理</a><span class="crumb-step">&gt;</span><span>新增管理员</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                	<select name="roleid">
                                		<?php if(is_array($roles)): foreach($roles as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["rolename"]); ?></option><?php endforeach; endif; ?>
                                	</select>
                                </td>
                            </tr>
                                <th></th>
