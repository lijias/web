            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/carshop/index.php/Admin/Privilege/add.html" class="btn btn-primary btn2"><i class="icon-font"></i>新增权限</a>
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Privilege/bdelete.html" type="submit" value="批量删除" class="btn btn-primary btn2"/></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($prires)): foreach($prires as $key=>$v): ?><tr>
                            <td class="tc"><input name="ids[]" value="<?php echo ($v["id"]); ?>" class="check" type="checkbox"></td>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["pri_name"]); ?></td>
                            <td><?php echo ($v["mname"]); ?></td>
                            <td><?php echo ($v["cname"]); ?></td>
                            <td><?php echo ($v["aname"]); ?></td>
                            <td><?php echo ($v["parentid"]); ?></td>
                            <td>
                                <a class="link-update" href="/carshop/index.php/Admin/Privilege/update/id/<?php echo ($v["id"]); ?>.html">修改</a>
                                <a class="link-del" onclick="return confirm('是否删除该分类下的所有类容!');" href="/carshop/index.php/Admin/Privilege/delete/id/<?php echo ($v["id"]); ?>.html">删除</a>
                            </td>
