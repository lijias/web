...
<head>
    ...
    <script type="text/javascript" src="/carshop/Public/jquery/jquery-1.4.js"></script>
 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Article/lst.html">文章管理</a><span class="crumb-step">&gt;</span><span>修改文章</span></div>
        </div>
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="cateid" id="catid" class="required">              
                                     <?php if(is_array($cates)): foreach($cates as $key=>$v): ?><option  <?php if($artres['cateid'] == $v['id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                <th>文章作者：</th>
                                <td>
                                    <input class="common-text required" id="author" name="author" size="50" value="<?php echo ($artres["author"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>关键词：</th>
                            ...
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="des" class="common-textarea" cols="45"  rows="5"><?php echo ($artres["des"]); ?></textarea></td>
                            </tr>  
                            <tr>
                                <th>是否推荐：</th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input name="pic" id="" type="file">
                                	<?php if($artres['pic'] != ''): ?><img src="/carshop<?php echo ($artres["pic"]); ?>" height="50"/>
                                	<?php else: ?>
                                	暂无缩略图<?php endif; ?>
