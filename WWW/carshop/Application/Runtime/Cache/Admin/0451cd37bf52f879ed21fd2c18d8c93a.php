 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">留言管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Message/bdelete.html" type="submit" value="批量删除" class="btn btn-primary btn2"/></a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            ...
                            <?php if($v['checked'] == 1): ?><td>审核通过</td>
                            <?php else: ?>
                            <td>审核未通过</td><?php endif; ?>
                            <td>
                                <a class="link-update" href="/carshop/index.php/Admin/Message/reply/id/<?php echo ($v["id"]); ?>.html">回复</a>
                                  <a class="link-update" href="/carshop/index.php/Admin/Message/checked/id/<?php echo ($v["id"]); ?>.html">审核</a>
                                <a class="link-del" onclick="return confirm('是否删除该留言吗!');" href="/carshop/index.php/Admin/Message/delete/id/<?php echo ($v["id"]); ?>.html">删除</a>
                            </td>
