 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Role/lst.html">角色管理</a><span class="crumb-step">&gt;</span><span>修改角色</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="rolename" size="50" value="<?php echo ($roles["rolename"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                	<ul>
                                	<?php foreach($prires as $k=>$v): if(strpos(','.$roles['pri_id_list'].',',','.$v['id'].',')!==false) { $check="checked='checked'"; } else { $check=""; } ?>                                	
