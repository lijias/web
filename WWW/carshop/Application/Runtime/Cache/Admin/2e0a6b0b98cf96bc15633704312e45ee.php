            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/carshop/index.php/Admin/Admin/add.html" class="btn btn-primary btn2"><i class="icon-font"></i>新增管理员</a>
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Admin/bdelete.html" type="submit"  value="批量删除"  class="btn btn-primary btn2" onclick="return confirm('是否批量删除管理员!');"/></a>                        
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($adminres)): foreach($adminres as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/carshop/index.php/Admin/Admin/update/id/<?php echo ($v["id"]); ?>.html">修改</a>
                                <?php if($v['id'] != 1): ?><a class="link-del" onclick="return confirm('是否删除该管理员!');" href="/carshop/index.php/Admin/Admin/delete/id/<?php echo ($v["id"]); ?>.html">删除</a><?php endif; ?>
                            </td>
