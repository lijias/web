 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Link/lst.html">连接管理</a><span class="crumb-step">&gt;</span><span>修改连接</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                	<input type="hidden" name="id" value="<?php echo ($linkres["id"]); ?>"/>
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>连接地址：</th>
                                <td><input class="common-text" name="url" size="50" value="<?php echo ($linkres["url"]); ?>" type="text"></td>
                            </tr>
                            <tr>
                                <th>连接描述：</th>
                                <td><textarea name="des" class="common-textarea" cols="75"  rows="6"><?php echo ($linkres["des"]); ?></textarea></td>
                            </tr>  
                            <tr>
                                <th></th>
                                <td>
