                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <?php if(is_array($replyres)): $i = 0; $__LIST__ = $replyres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                <th><i class="require-red" ></i>回复<?php echo ($i); ?>：</th>
                                <td>
                                   <?php echo ($v["content"]); ?>
                                </td>
                            ...
                            <tr>
                                <th>管理员回复：</th>
                                <td><textarea name="content" class="common-textarea" cols="75"  rows="6"><?php echo ($linkres["des"]); ?></textarea></td>
                            </tr>  
                            <tr>
                                <th></th>
                                <td>
