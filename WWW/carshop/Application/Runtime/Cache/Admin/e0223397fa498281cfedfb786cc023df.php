 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Cate/lst.html">栏目管理</a><span class="crumb-step">&gt;</span><span>修改栏目</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <td>
                                <select name="parentid" id="catid" class="required">
                                    <option value="0">顶级栏目</option>
                                     <?php if(is_array($cates)): foreach($cates as $key=>$v): if($v['id'] == $cateres['parentid']): ?><option  selected="selected"<?php if($v['id'] == $cateres['id']): ?>style="display:none;"<?php endif; ?> value="<?php echo ($v["id"]); ?>" > <?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["name"]); ?></option>
                                    <?php else: ?>
                                    <option <?php if($v['id'] == $cateres['id']): ?>style="display:none;"<?php endif; ?> value="<?php echo ($v["id"]); ?>" > <?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["name"]); ?></option><?php endif; endforeach; endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="des" class="common-textarea" cols="45"  rows="5"><?php echo ($cateres["des"]); ?></textarea></td>
                            </tr>  
                            <tr>
                                <th>栏目类型：</th>
                                <td>
                           ...
                           <tr>
                                ...
                                <td><input name="pc" value="1" <?php if($cateres['pc'] == 1): ?>checked="checked"<?php endif; ?> type="checkbox"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
                            </tr>                                                    
                            <tr>
