 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Cate/lst.html">栏目管理</a><span class="crumb-step">&gt;</span><span>新增栏目</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <td>
                                <select name="parentid" id="catid" class="required">
                                    <option value="0">顶级栏目</option>
                                     <?php if(is_array($cates)): foreach($cates as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="des" class="common-textarea" cols="45"  rows="5"></textarea></td>
                            </tr>  
                            <tr>
                                <th>栏目类型：</th>
                                <td>
                                	<input class="common-text" name="type" size="50" checked=checked value="1" type="radio">列表
                            ...
                            <tr>
                                <th>栏目级别：</th>
                                <td>
                                	<input class="common-text" name="class" size="50" checked=checked value="1" type="radio">顶级
                            ...
                            <tr>
                                ...
                                <td><input name="pc" value="1" checked="checked" type="checkbox"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
                            </tr>                                                     
                            <tr>
