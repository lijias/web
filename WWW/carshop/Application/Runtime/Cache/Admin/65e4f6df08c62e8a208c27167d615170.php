 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">连接管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/carshop/index.php/Admin/Link/add.html" class="btn btn-primary btn2"><i class="icon-font"></i>新增连接</a>
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Link/bdelete.html" type="submit" value="批量删除" class="btn btn-primary btn2"/></a>
                        <a id="updateOrd" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Link/sortcate.html" type="submit" value="更新排序" class="btn btn-primary btn2"/></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($linkres)): foreach($linkres as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/carshop/index.php/Admin/Link/update/id/<?php echo ($v["id"]); ?>.html">修改</a>
                                <a class="link-del" onclick="return confirm('是否删除该连接吗!');" href="/carshop/index.php/Admin/Link/delete/id/<?php echo ($v["id"]); ?>.html">删除</a>
                            </td>
