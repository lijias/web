 ...
 <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Role/lst.html">角色管理</a><span class="crumb-step">&gt;</span><span>新增角色</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                	<ul>
                                	<?php if(is_array($prires)): foreach($prires as $key=>$v): ?><li level="<?php echo ($v["level"]); ?>">                               			
                                			<input class="common-text" name="pri_id_list[]" size="50" value="<?php echo ($v["id"]); ?>" type="checkbox">
                                			<?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8);?>
                                			<?php echo ($v["pri_name"]); ?>             			
