                        ...
                        <tr>
                            ...
                            <td>
                                <select name="search-sort" id="">
                                    ...
                                    <?php if(is_array($cates)): foreach($cates as $key=>$v): ?><option <?php if($v['type'] != 1): ?>style="display:none;"<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php if($v['parentid'] != 0): ?>|<?php endif; echo str_repeat('-',$v['level']*8); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </td>
                            <th width="70">关键字:</th>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/carshop/index.php/Admin/Article/add.html" class="btn btn-primary btn2"><i class="icon-font"></i>新增文章</a>
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Article/bdelete.html" type="submit" value="批量删除" class="btn btn-primary btn2"/></a>                        
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/carshop/index.php/Admin/Article/update/id/<?php echo ($v["id"]); ?>.html">修改</a>
                                <a class="link-del" onclick="return confirm('是否删除该文章!');" href="/carshop/index.php/Admin/Article/delete/id/<?php echo ($v["id"]); ?>.html">删除</a>
                            </td>
