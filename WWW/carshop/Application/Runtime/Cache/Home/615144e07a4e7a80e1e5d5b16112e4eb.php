...
<div class="headtop">
	...
	<div class="nav">
    	<ul>
        	...
        	<?php if(is_array($navres)): foreach($navres as $key=>$v): ?><li><a href="/carshop/index.php/Home/<?php if($v['type'] == 1): ?>Arlist
            										...
            										<?php elseif($v['type'] == 7): ?>Job<?php endif; ?>/index/cateid/<?php echo ($v["id"]); ?>" title="<?php echo ($v["name"]); ?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
       </ul>
    </div>
...
function ckvaild (inp) {
	...
	if (r==0) {
		$("#verify").attr("src",'./carshop/Public/pc/valid.php?rand='+Math.random()*5);
		return false;
	} else {
		return true;
	}
    ...
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Job/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
...
邮箱：<?php echo (C("EMAIL")); ?></div>
  ...
  <div class="fyRight">
      <div class="title"> <span class="fl"> <?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <font>人才招聘</font> </span></div>
      <div class="hrfra">
        ...
        <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center" class="hr"> 
            ...
            <input type="text" name="title" style="color:#999" size="50" maxlength="30" readonly="readonly" value="<?php echo ($title); ?>" />
            </td>
            </tr>
            <tr>
            <td height="25" align="right"  class="bord"><span class="c_red">*</span>真实姓名：</td>
            <td height="25" align="left" class="bord">
            <input type="text" name="name" size="15" maxlength="30" valid="required" errmsg="请输入真实姓名！" />
            </td>
            ...
            <td height="25" align="left" class="bord">
            <input type="text" name="foreign" size="18" maxlength="35" />
            </td>
            </tr>
            <tr>
            <td width="14%" height="25" align="right" class="bord"><span class="c_red">*</span>移动电话：</td>
            <td width="27%" height="25" align="left" class="bord">
            <input type="text" name="mobile" size="20" maxlength="11" valid="required|isMobile" errmsg="请输入移动电话！|移动电话格式不正确！" />
            </td>
            <td width="17%" height="25" align="right" class="bord">电子邮件：</td>
            <td width="42%" height="25" align="left" class="bord">
            <input type="text" name="email" size="25" maxlength="35" valid="isEmail" errmsg="电子邮件格式不正确！" />
            </td>
            </tr>
            <tr>
            <td height="25" align="right" class="bord">身份证号：</td>
            <td height="25" align="left" class="bord">
            <input type="text" name="idnums" maxlength="36" value="" valid="isIdCard" errmsg="身份证号码格式不正确！" />
            </td>
            <td height="25" align="right" class="bord"><span class="STYLE2">现住址：</span></td>
            <td height="25" align="left" class="bord">
            <input type="text" name="address_now" size="40" maxlength="20" />
            </td>
            </tr>
            <tr>
            ...
            <td height="25" colspan="3" align="left" class="bord">
                <input type="text" size="12" name="verify" id="vaild" custom="ckvaild" valid="required|custom" errmsg="请输入验证码|验证码输入有误，请重新输入" border="0" maxlength="4" />
               <img id="verify" src="/carshop/index.php/Home/Job/code" style="height:30px;"alt="看不清？点击一下！" title="看不清？点击一下！" style="cursor:pointer;" onclick="document.getElementById('verify').src='/carshop/index.php/Home/Job/code?rand='+Math.random()*5;" align="absmiddle" /> 
            </td>
            </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <input type="submit" name="hrsbtn" class="hr_btn" style="cursor:pointer;" value="提交求职表" title="提交求职表"  onclick="return validator(document.hrform);" />
            </td>
            </tr>
        </table>
        </form>
