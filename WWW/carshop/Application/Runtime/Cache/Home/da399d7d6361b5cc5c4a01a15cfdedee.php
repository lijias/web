...
邮箱：这里是您公司的邮箱地址</div>
        ...
        <div class="fyRight">
      			<div class="title"> <span class="fl"> <?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <font>资质荣誉</font> </span></div>
		    <ul class="case-ul">
       		<?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
			        <a href="http://0001543.ks.panguweb.cn/honor_view.php?id=87" title="<?php echo ($v["title"]); ?>">
			                <img src="/carshop/<?php echo ($v["pic"]); ?>" width="245" height="184" alt="2013年沈阳盘古妇女节活动报道" />
			                       <p class="wor"><?php echo ($v["title"]); ?></p>
			         </a>
