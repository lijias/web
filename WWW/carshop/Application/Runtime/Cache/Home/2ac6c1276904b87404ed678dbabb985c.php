...
<script src="/carshop/Public/pc/style/fy.js"></script>
<div class="fy" style=" background:url(/carshop/Public/pc/images/20150804113438-369103644.jpg) center top no-repeat;">
    ...
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
            <ul class="l_procon">
            <?php foreach ($son2 as $k=>$v): $cateid=$v['id']; if($contro) { $url="/carshop/index.php/Home/carlist/index/cateid/$cateid"; } else { $url="/carshop/index.php/Home/Article/index/cateid/$cateid"; } ?>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Article/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
...
邮箱：<?php echo (C("EMAIL")); ?></div>
        ...
        <div class="fyRight">
                ...
                <div class="aaleft1" >
      			...
      			<div class="title"> <span class="fl"> <?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <a href="case.php" title="主要车型">主要车型</a> > <font>一级分类名称-1</font> </span></div>
				<div class="padding25">
                    ...
                    <p class="title_s">文章作者：<?php echo ($articles["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;时间：<?php echo (date("Y-m-d",$articles["time"])); ?></p>
                                        <p class="center">
                                        <?php if($articles['pic'] != '' ): ?><img src="/carshop/<?php echo ($articles["pic"]); ?>" alt="车型：车型展示名称" />
                                        <?php else: ?>
                                        	暂无图片<?php endif; ?>
                                        </p>
                                        
                                        <p class="pro-ri">
                                        <?php if($articles['rizu'] != '' ): ?>日租：<?php echo ($articles["rizu"]); ?>元/天<?php endif; ?>
                                        	</p>
                     <p class="pro_cname"><span>详细介绍</span></p>
                    <div class="newsview">
                     
                     <div class='pb'><div class='pagebox'> <?php echo htmlspecialchars_decode($articles['content']);?><div align='center'></div></div></div></div>
