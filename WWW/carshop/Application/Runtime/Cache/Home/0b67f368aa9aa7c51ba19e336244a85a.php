    ...
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Arlist/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
...
邮箱：<?php echo (C("EMAIL")); ?></div>
        ...
        <div class="fyRight">
		 ...
		 <ul class="news_list">
		 <?php if(is_array($list)): foreach($list as $key=>$v): ?><li><a href="/carshop/index.php/Home/Article/index/arid/<?php echo ($v["id"]); ?>" title="<?php echo ($v["title"]); ?>"><span class="fl"><?php echo ($v["title"]); ?></span><span class="fr"><?php echo (date("Y-m-d",$v["time"])); ?></span></a></li><?php endforeach; endif; ?>
		</ul>    
