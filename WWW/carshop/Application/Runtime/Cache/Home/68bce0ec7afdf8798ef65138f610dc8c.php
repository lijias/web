    ...
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Page/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
...
邮箱：<?php echo (C("EMAIL")); ?></div>
    ...
    <div class="fyRight">
      <div class="title"> <span class="fl">
        <?php echo ($selftop); ?>       </span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <font>关于我们</font>        </span></div>
      <div class="padding25">
