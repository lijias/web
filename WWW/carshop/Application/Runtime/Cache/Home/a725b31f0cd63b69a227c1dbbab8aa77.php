  ...
  <div class="fyLeft">
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
            <ul class="l_procon">
            <?php foreach ($son2 as $k=>$v): $cateid=$v['id']; if($contro) { $url="/carshop/index.php/Home/carlist/index/cateid/$cateid"; } else { $url="/carshop/index.php/Home/Zplist/index/cateid/$cateid"; } ?>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Zplist/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
...
邮箱：<?php echo (C("EMAIL")); ?></div>
  ...
  <div class="fyRight">
      <div class="title"> <span class="fl"> <?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <font>人才招聘</font> </span></div>
             ...
             <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="hrBox">
      <div class="hrBoxL">
        <ul>
      ...
      <div class="hrBoxR">
        <ul>
          <li class="topline"><span class="fl"> <?php echo ($v["title"]); ?></span><a href="/carshop/index.php/Home/Job/index/arid/<?php echo ($v["id"]); ?>" class="fr" title="应聘此职位"><img src="/carshop/Public/pc/images/re.gif" width="90" height="26" /></a>
            <div class="clear"></div>
          </li>
          <li class="bgWhite"><?php echo ($v["num"]); ?>            <div class="clear"></div>
          </li>
          <li class="haode"> <?php echo htmlspecialchars_decode($v['des']);?></li>
        </ul>
        <div class="clear"></div>
      </div>
