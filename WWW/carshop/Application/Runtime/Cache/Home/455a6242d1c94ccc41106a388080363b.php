...
<script language="JavaScript" type="text/javascript" src="/carshop/Public/pc/style/ajax.js"></script>
...
<div class="fy" style=" background:url(/carshop/Public/pc/images/20150804113438-369103644.jpg) center top no-repeat;">
    ...
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
            <ul class="l_procon">
            <?php foreach ($son2 as $k=>$v): $cateid=$v['id']; if($contro) { $url="/carshop/index.php/Home/carlist/index/cateid/$cateid"; } else { $url="/carshop/index.php/Home/Message/index/cateid/$cateid"; } ?>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Message/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
...
邮箱：<?php echo (C("EMAIL")); ?></div>
        ...
        <div class="fyRight">
		<div class="title"> <span class="fl">  <?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <font>在线留言</font></span></div>				
    		<div class="book">
    		<?php if(is_array($mres)): $i = 0; $__LIST__ = $mres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="pngFix booktop">
            <div class="booktop_name"><span class="messagecol">
              <?php echo ($v["nickname"]); ?>              </span> 说：</div>
            <div class="booktop_time">
              2015年8月10日 09:46            </div>
          </div>
          <div class="bookcontent">
             <?php echo ($v["content"]); ?>        <span>
              <?php echo (date("Y年m月d日 H:i",$v["time"])); ?>              </span>   </div>
              <?php if(is_array($pres)): $i = 0; $__LIST__ = $pres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i; if($v['id'] == $v1['mid']): ?><div class="bookadmin">
            ...
            <div class="bookadmin_mid"><span class="admincol fl">管理员回复：</span><span class="txtcon fl" style="width:400px;">
              <?php echo ($v1["content"]); ?>              </span><span>
              <?php echo (date("Y年m月d日 H:i",$v1["time"])); ?>              </span>></div>
      ...
      <form method="post" name="MsgForm" id="MsgForm" action="" >
        ...
        <ul>
          ...
          <li class="yzm">
            ...
            <p class="message_yzmico"><img id="verify" src="/carshop/index.php/Home/Message/code" style="height:30px;" alt="看不清？点击一下！" title="看不清？点击一下！" style="cursor:pointer;" onclick="document.getElementById('verify').src='/carshop/index.php/Home/Message/code?rand='+Math.random()*5;" align="absmiddle" /></p>
            <p class="message_sub"><input type="submit" value="提交留言" style="width:90px;cursor:pointer;"/></p>
          </li>
        </ul>
        </form>
      </div>
