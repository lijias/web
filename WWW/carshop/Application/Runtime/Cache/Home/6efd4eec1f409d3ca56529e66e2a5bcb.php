...
<div class="fy" style=" background:url(/carshop/Public/pc/images/20150804113438-369103644.jpg) center top no-repeat;">
    ...
    <div class="l_pro">
      <div class="l_pro_t"><?php echo ($topname); ?></div>
            <ul class="l_procon">
            <?php foreach ($son2 as $k=>$v): $cateid=$v['id']; if($contro) { $url="/carshop/index.php/Home/carlist/index/cateid/$cateid"; } else { $url="/carshop/index.php/Home/Rylist/index/cateid/$cateid"; } ?>
			...
			<?php foreach ($son3 as $k1=>$v1):?>
				<li><a style="padding-left:50px;" href="/carshop/index.php/Home/Rylist/index/cateid/<?php echo $v1['id'];?>" title="<?php echo $v1['name'];?>"><?php echo $v1['name'];?></a></li>			
			<?php endforeach;?>	
			<?php endif;?>								
			</ul>
			</li>
        ...
        <div class="fyRight">
		    ...
		    <ul class="case-ul">
       		<?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
			        <a href="/carshop/index.php/Home/Article/index/arid/<?php echo ($v["id"]); ?>" title="<?php echo ($v["title"]); ?>">
