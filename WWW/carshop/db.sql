...
CREATE TABLE IF NOT EXISTS `cs_article` (
  ...
  `pic` varchar(60) NOT NULL,/*缩略图*/
  `content` text NOT NULL,/*正文*/
  `keywords` varchar(60) NOT NULL,/*关键词*/
  `des` varchar(255) NOT NULL,/*描述*/
  `rem` tinyint(1) NOT NULL DEFAULT '0',/*是否推荐*/
  `cateid` mediumint(5) NOT NULL,/*栏目id*/
...
CREATE TABLE IF NOT EXISTS `cs_cate` (
  `id` mediumint(5) NOT NULL AUTO_INCREMENT, /*栏目id*/
  `name` varchar(30) DEFAULT NULL,/*栏目名称*/
  `type` tinyint(1) DEFAULT '1',/*栏目类型*/
  `pc` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否是pc端栏目',
  `class` tinyint(1) NOT NULL DEFAULT '1' COMMENT '//栏目级别',
  `sort` mediumint(5) DEFAULT '50',/*栏目排序*/
  `pic` varchar(255) DEFAULT NULL,/*栏目图片*/
  `content` text NOT NULL,/*栏目内容*/
  `keywords` varchar(60) DEFAULT NULL,/*栏目关键词*/
  `des` varchar(255) DEFAULT NULL,/*栏目描述*/
  `parentid` mediumint(5) NOT NULL,/*上级栏目id*/
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `cs_link` (
  ...
  `url` varchar(60) NOT NULL,/*地址*/
  `des` varchar(255) NOT NULL,/**/
  `sort` mediumint(5) NOT NULL DEFAULT '50',/*排序*/
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `cs_privilege` (
  ...
  `mname` varchar(20) NOT NULL COMMEN T '//模块名称',
...
CREATE TABLE IF NOT EXISTS `cs_role` (
  ...
  `pri_id_list` varchar(60) NOT NULL,/*权限的id*/
  PRIMARY KEY (`id`)
