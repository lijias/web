...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  ...
  <script type="text/javascript" src="/TP/t/Public/js/common.js"></script><script type="text/javascript" src="/TP/t/Public/js/global.js"></script><script type="text/javascript" src="/TP/t/Public/js/compare.js"></script>
  <style type="text/css">
...
<div class="p_w" style="clear:both; overflow:hidden"></div>
  ...
  <h3><a href=".">首页</a> <code>&gt;</code>  <?php echo ($navStr); ?> <?php echo ($type["tname"]); ?></h3>
</div>
<div class="blank"></div>	
    <div id="globalLeft"> 
...
<div id="globalGoodsList" class="globalModule">
 ...
 <div class="list_b">
<span>
总计 <b><?php echo ($count); ?></b>  个记录</span>
</div>
    <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
      <div class="itemList">
      <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><div class="item">
      		<p class="pic">
       		 <a href="/TP/t/index.php/Home/Product/detail/id/<?php echo ($v["id"]); ?>/tid/<?php echo ($tid); ?>"><img src="/TP/t/Public/product/<?php echo ($v["imagename"]); ?>" alt="<?php echo ($v["title"]); ?>" /></a>
      	   </p>
      <div class="itemListInfo">
      <div style="float:left;">
        <p class="name"><a href="goods.php?id=4778" title="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></a></p>
        <p class="price">
                    市场价：<span class="marketPrice">￥<?php echo ($v["price"]); ?>元</span><br />
                    美智价：<span class="goodsPrice">￥<?php echo ($v["saleprice"]); ?>元</span>
        </p>
	 </div>                    
