...
<div  style="float:right; color:#acacac; padding-right:15px;">         
   <script type="text/javascript" src="/TP/t/Public/js/transport.js"></script><script type="text/javascript" src="/TP/t/Public/js/utils.js"></script>   <font id="ECS_MEMBERZONE">您好，beifang, 欢迎您回来！</span>
...
<div class="blank"></div>
  ...
  <div class="flowBox">
           ...
           <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
            <tr>
              ...
              <td bgcolor="#ffffff" align="left">
                                                      <a href="goods.php?id=4779" target="_blank"><img src="/TP/t/Public/images/no_picture.gif" border="0" title="产品20" /></a><br />
                    <a href="goods.php?id=4779" target="_blank" class="f6">产品20</a>
                                                                                    </td>
            
                             <td bgcolor="#ffffff"></td>
                            <td align="center" bgcolor="#ffffff">￥999.00元</td>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
          <tr>
            <td bgcolor="#ffffff" style="padding:20px;0"><a href="./"><img style="vertical-align:middle;" src="/TP/t/Public/themes/jindong/images/jixubuy.gif" /></a>&nbsp;&nbsp;&nbsp;&nbsp;

            
            <input style="vertical-align:middle;"  type="button" value="" class="clear_car" onclick="location.href='flow.php?step=clear'" />&nbsp;&nbsp;&nbsp;&nbsp;
            
            
            <input style="vertical-align:middle;" name="submit" type="submit" class="gengxin_car" value="" /></td>
            <td bgcolor="#ffffff" align="right" style="padding:20px;0"><a href="checkout.html"><img src="/TP/t/Public/themes/jindong/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
         </form>
