...
<a href="/TP/t/index.php/Home/Cart/checkout"><img src="/TP/t/Public/themes/jindong/images/qujiesuan.gif"></a>
</div>
  </form>
...
<div class="usBox_in "  style="position:relative">
    ...
    <form  action="" method="post" name="formUser" onsubmit="return register();" style="background:none"> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div>
...
<td align="right" >密码问题答案</td>
	  ...
	  <input name="answer" type="text" size="25" class="inputBg" maxlengt='20'/>          </td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="left">
           <input  type="submit" value="" style=" width:136px; height:35px; border:none; background:url(/TP/t/Public/themes/jindong/images/bnt_ur_reg.gif) no-repeat">
          </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
