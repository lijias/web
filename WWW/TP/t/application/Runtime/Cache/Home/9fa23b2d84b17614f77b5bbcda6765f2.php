...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  ...
  <script type="text/javascript" src="/TP/t/Public/js/common.js"></script><script type="text/javascript" src="/TP/t/Public/js/global.js"></script><script type="text/javascript" src="/TP/t/Public/js/compare.js"></script></head>
<body>
    <div id="container">
...
<div style="float:right; _padding-top:9px; background: url(/TP/t/Public/themes/jindong/images/nav_bg2.gif) 0 top no-repeat; height:29px; padding-left:28px;">
				<a href="search.php?intro=promotion"  >今日特价</a> <img style="vertical-align:middle" src="/TP/t/Public/themes/jindong/images/nav_li.gif">
			  		...
			  		<a href="flow.php"  >查看购物车</a> <img style="vertical-align:middle" src="/TP/t/Public/themes/jindong/images/nav_li.gif">
...
<div  style="float:right; color:#acacac; padding-right:15px;">         
   <script type="text/javascript" src="/TP/t/Public/js/transport.js"></script><script type="text/javascript" src="/TP/t/Public/js/utils.js"></script>   <font id="ECS_MEMBERZONE">
...
<div id="globalNav">
  <ul>
<li><a href="/TP/t/index.php" class="cur">首页</a></li>
<?php if(is_array($pArr)): foreach($pArr as $key=>$v): ?><li><a href="/TP/t/index.php/index/productlst/id/<?php echo ($v["id"]); ?>"  ><?php echo ($v["tname"]); ?></a></li><?php endforeach; endif; ?>
...
<a href="flow.php"><span>购物车中有<b>1</b>件商品</span>
  ...
  <li>
 <div class="f_l">
 <a class="img" href="goods.php?id=4761"><img src="/TP/t/Public/images/201208/thumb_img/4761_thumb_G_1344186486336.jpg" style="width:50px; height:50px;" alt="产品1"></a>
...
<a href="flow.php?step=checkout"><img src="/TP/t/Public/themes/jindong/images/qujiesuan.gif"></a>
</div>
  </form>
...
<div class="item hot_item2">
      <p  class="pic"><a href="goods.php?id=4765"><img style="width:100px; height:100px;margin:0 auto; float:left; text-align:center" src="/TP/t/Public/images/no_picture.gif" alt="产品5"/></a></p>
     ...
     <a href="javascript:addToCart(4765)"> <img src="/TP/t/Public/themes/jindong/images/bnt1.gif"> </a>
      </div>
 ...
 <div class="item hot_item2">
      <p  class="pic"><a href="productDetail.html"><img style="width:100px; height:100px;margin:0 auto; float:left; text-align:center" src="/TP/t/Public/images/no_picture.gif" alt="产品4"/></a></p>
     ...
     今日特价：<font class="shop_s">￥11111111元                </font>
      ...
      <div style="padding-top:5px;">
     <a href="javascript:addToCart(4764)"> <img src="/TP/t/Public/themes/jindong/images/bnt1.gif"> </a>
      </div>
 ...
 <div class="item hot_item2">
      <p  class="pic"><a href="productDetail.html"><img style="width:100px; height:100px;margin:0 auto; float:left; text-align:center" src="/TP/t/Public/images/no_picture.gif" alt="产品2"/></a></p>
     ...
     今日特价：<font class="shop_s">￥11111111元                </font>
      ...
      <div style="padding-top:5px;">
     <a href="javascript:addToCart(4762)"> <img src="/TP/t/Public/themes/jindong/images/bnt1.gif"> </a>
      </div>
...
<!--
.Select {
background:url(/TP/t/Public/themes/jindong/images/tag_title2.gif) repeat-x 0 top;
...
<div id="globalGoodsList" class="globalModule">
  <div class="globalGoodsListMenu2">
    <form method="get" action="#" class="sort" name="listform">
      <span style="position:relative; top:-5px;">排序：</span>
        <a href="category.php?category=296&display=list&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="/TP/t/Public/themes/jindong/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=296&display=list&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="/TP/t/Public/themes/jindong/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=296&display=list&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="/TP/t/Public/themes/jindong/images/last_update_default.gif" alt="按更新时间排序"></a>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('list')"><img src="/TP/t/Public/themes/jindong/images/btn_display_mode_list_act.gif" alt=""></a>
  <a href="javascript:;" onClick="javascript:display_mode('grid')"><img src="/TP/t/Public/themes/jindong/images/btn_display_mode_grid.gif" alt=""></a>
  <a href="javascript:;" onClick="javascript:display_mode('text')"><img src="/TP/t/Public/themes/jindong/images/btn_display_mode_text.gif" alt=""></a>&nbsp;&nbsp;
...
总计 <b>18</b>  个记录</span>
    ...
    <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
      <div class="itemList">
      //////////////////////////////
      <foreache name="pArr" item="v">
        <div class="item">
      		<p class="pic">
       		 <a href="productDetail.html"><img src="/TP/t/Public/images/no_picture.gif" alt="产品19" /></a>
      	   </p>
      <div class="itemListInfo">
      <div style="float:left;">
        <p class="name"><a href="goods.php?id=4778" title="产品19">产品19</a></p>
        <p class="price">
        ...
        <p class="btnList">
          <a href="javascript:collect(4778)"><img src="/TP/t/Public/themes/jindong/images/buttons_coll.gif"></a> <a href="javascript:addToCart(4778)"><img src="/TP/t/Public/themes/jindong/images/buttons_buy.gif"></a> <a href="javascript:;" onClick="Compare.add(4778,'产品19')"><img src="/TP/t/Public/themes/jindong/images/buttons_comp.gif"></a>
        </p>
        </div>
      </div>
    </div>
