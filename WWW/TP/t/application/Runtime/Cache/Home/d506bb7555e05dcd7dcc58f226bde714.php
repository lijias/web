...
<link href="/TP/t/Public/themes/jindong/stye1024.css" rel="stylesheet" type="text/css" />  
...
<div id="urHere" class="globalModule">
  <h3><a href="/TP/t/index.php">首页</a> <code>&gt;</code> 购物流程</h3>
</div>
<div class="blank"></div>
    
  
  <script type="text/javascript" src="/TP/t/Public/js/showdiv.js"></script>  <script type="text/javascript">
  ...
  <div class="flow_tou">
      <img  style="float:left"src="/TP/t/Public/themes/jindong/images/cart_001.gif" />
  ...
  <div class="flowBox">
        <form id="formCart" name="formCart" method="post" action="/TP/t/index.php/Home/Cart/index">
           <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
            ...
            <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
              <td bgcolor="#ffffff" align="left">
                   <a href="goods.php?id=4779" target="_blank"><img src="/TP/t/Public/product/<?php echo ($v["image"]); ?>" height="50px" border="0" title="<?php echo ($v["title"]); ?>" /></a><br />
                    <a href="goods.php?id=4779" target="_blank" class="f6"><?php echo ($v["title"]); ?></a>
             </td>
             <td bgcolor="#ffffff"><?php echo ($v["style"]); ?></td>
             <td align="center" bgcolor="#ffffff">￥<?php echo ($v["saleprice"]); ?>元</td>
             <td align="center" bgcolor="#ffffff">
               <input type="text" name="goods_number[43]" id="goods_number_43" value="<?php echo ($v["buynum"]); ?>" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
             </td>
             <td align="center" bgcolor="#ffffff">￥<?php echo ($v["money"]); ?>元</td>
             <td align="center" bgcolor="#ffffff">
                <a href="javascript:if (confirm('您确实要把该商品移出购物车吗？')) location.href='/TP/t/index.php/Home/Cart/delete/id/<?php echo ($v["id"]); ?>'; " class="f6">删除</a>
             </td>
            </tr><?php endforeach; endif; ?>
             <tr>
              <td colspan="7" align="right" bgcolor="#ebf4fb" style="color:#F00; font-weight:bold">
              购物金额小计 ￥<?php echo ($cmoney); ?>元</td>
             </tr>
          </table>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
          <tr>
            <td bgcolor="#ffffff" style="padding:20px;0">
            	<a href="/TP/t/index.php/Home/Product/lst/tid/1">
            		<img style="vertical-align:middle;" src="/TP/t/Public/themes/jindong/images/jixubuy.gif" />
            	</a>&nbsp;&nbsp;&nbsp;&nbsp;    
            <input style="vertical-align:middle;"  type="button" value="" class="clear_car" onclick="location.href='/TP/t/index.php/Home/Cart/deleteAll'" />&nbsp;&nbsp;&nbsp;&nbsp; 
            <input style="vertical-align:middle;" name="submit" type="submit" class="gengxin_car" value="" /></td>
            <td bgcolor="#ffffff" align="right" style="padding:20px;0"><a href="/TP/t/index.php/Home/Cart/checkout.html"><img src="/TP/t/Public/themes/jindong/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
         </form>
