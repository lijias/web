...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  ...
  <script type="text/javascript" src="/TP/t/Public/js/common.js"></script><script type="text/javascript" src="/TP/t/Public/js/user.js"></script></head>
...
<li><a href="../welcome.html" ><img src="/TP/t/Public/themes/jindong/images/u1.gif"> 欢迎页</a>
<li><a href="../userinfo.html"><img src="/TP/t/Public/themes/jindong/images/u2.gif"> 用户信息</a>
<li><a href="../dingdan.html"><img src="/TP/t/Public/themes/jindong/images/u3.gif"> 我的订单</a>
<li><a href="../address.html"class="curs"><img src="/TP/t/Public/themes/jindong/images/u4.gif"> 收货地址</a>
<li><a href="../shoucang.html"><img src="/TP/t/Public/themes/jindong/images/u5.gif"> 我的收藏</a>
<li><a href="../message.html"><img src="/TP/t/Public/themes/jindong/images/u6.gif"> 我的留言</a>
<li><a href="../user.php?act=logout" style="background:none; text-align:right; margin-right:10px;"><img src="/TP/t/Public/themes/jindong/images/bnt_sign.gif"></a>
</div>

</div>    </div>
    <div id="globalBigRight">
    <div class="tab_box">
                                                                                                  <script type="text/javascript" src="/TP/t/Public/js/region.js"></script><script type="text/javascript" src="/TP/t/Public/js/shopping_flow.js"></script>      <script type="text/javascript">
      //<![CDATA[
      ...
      <div class="globalModule">
        ...
        <?php if(is_array($addinfoArr)): foreach($addinfoArr as $key=>$v): ?><form action="/TP/t/index.php/User/Addr/update" method="post" name="theForm" onsubmit="return checkConsignee(this)">
            <table cellspacing="0" class="tableList">
              ...
              <tr>
                <td colspan="4" align="center">
                  ...
                  <input name="button" type="button" onclick="if (confirm('你确认要删除该收货地址吗？'))location.href='/TP/t/index.php/User/Addr/del/id/<?php echo ($v["id"]); ?>'" value="删除" />
          ...
          <form action="/TP/t/index.php/User/Addr/add" method="post" name="theForm" onsubmit="return checkConsignee(this)">
            <table cellspacing="0" class="tableList">
              ...
              <tr>
                ...
                <td><input name="name" type="text" id="consignee_1" value="" class="textInput" />
                  <span class="textDesc">(必填)</span> </td>
                <td>电子邮件地址:</td>
                <td><input name="email" type="text" id="email_1" value="" class="textInput" />
                  <span class="textDesc">(必填)</span></td>
              </tr>
              <tr>
                <td>详细地址:</td>
...
<li><a href="../http://www.miibeian.gov.cn"><img src="/TP/t/Public/themes/jindong/images/fot_1.gif"></a> <li><a href="../#"><img src="/TP/t/Public/themes/jindong/images/fot_2.gif"></a> <li><a href="../http://police.cnool.net/infoCategoryListAction.do?act=init"><img src="/TP/t/Public/themes/jindong/images/fot_3.gif"></a>
 </div>      
</div>  </div>
</body>
</html>