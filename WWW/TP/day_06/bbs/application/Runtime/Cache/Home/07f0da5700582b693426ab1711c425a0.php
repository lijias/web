...
<br><br>
    ...
    <form name="frm" method="post" action="/bbs/index.php/Login/login">
    <table border="1" align="center">
      ...
      <tr>
        <td>验证码：</td>
        <td><input type="text" name="checkCode" size="7"><img src="/bbs/index.php/Login/image" align="absmiddle"></td>
      </tr>
      <tr>
