...
$result=$db->select("cms_article", "id,title","tid=1","10");
$result_gj=$db->select("cms_article", "id,title","tid=2","10");
?>
...
<div class="section clear">
	...
	<div class="side-left">
		...
		<?php while ($row=mysql_fetch_assoc($result)){?>
			<li><a href="<?php echo $row['id'];?>" target="_blank"><?php echo $row['title']?></a></li>
	    <?php }?>
        </ul>
	</div>
...
<div class="section clear">
	...
	<div class="side-left">
		...
		<ul class="section-part-list">
		<?php while ($row_gj=mysql_fetch_assoc($result_gj)){?>
			<li><a href="<?php echo $row_gj['id'];?>" target="_blank"><?php echo $row_gj['title'];?></a></li>
			<?php }?>
        </ul>
	</div>
	<div class="side-center">
