...
$cur_page=isset($_POST['currentPage'])?$_POST['currentPage']:1;
if ($cur_page<1){
 $cur_page=1;
...
if ($shangyiye>=1){
$list="<a href='#' onclick='setPage(1)'>首页</a>&nbsp;<a href='#' onclick='setPage($shangyiye)'>上一页</a>";
}
return $list;
}
//1234567
...
$n=$this->cur_page-$i;
if ($n>=1){
$list.="&nbsp;<a href='#' onclick='setPage($n)'>$n</a>&nbsp;";
}
}
$list.="&nbsp;$this->cur_page&nbsp;";
for ($i=1;$i<=$num;$i++){
...
$list="<a href='#' onclick='setPage($xiayiye)'>下一页</a>&nbsp;<a href='#' onclick='setPage($this->totalpage)'>尾页</a>";
}
return $list;
}
}
