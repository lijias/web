...
//操作数据库 tid=5 新闻分类 “内地新闻” 5
$query = "select id,title from article where tid=5 limit 10";
$result = mysql_query($query);
//读取 “港澳台新闻” tid=6
$query = "select id,title from article where tid=6 limit 10";
$result_6  = mysql_query($query);
?>
...
<div class="section clear">
	...
	<div class="side-left">
		...
		?>
			<li><a href="articles.php?id=<?php echo $row['id'] ?>" target="_blank">
			<?php echo $row['title'] ?>
			</a></li>
			<?php } ?>
		</ul>
	...
	<div class="side-center">
		...
		<ul class="section-part-list">
		    <?php while($row = mysql_fetch_assoc($result_6)){ ?>
			<li><a href="articles.php?id=<?php echo $row['id']; ?>" target="_blank"><?php echo $row["title"];  ?></a></li>
			<?php } ?>
	    </ul>	
	</div>
