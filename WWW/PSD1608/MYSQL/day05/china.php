	...
	<div class="side-left-680">
		...
		<div>
			<div class="news-list-item clear">
				<div class="news-list-item-pic"><a href="#"><img src="photoview/638990D050163D3495FCF397FC87F9E0.jpg.165x100.jpg" alt=""/></a></div>
				<div class="news-list-item-txt">
					<h1><a href="#">美国安部暂避停摆危机 拨款问题成两党之争焦点</a></h1>
					<p>图为伊拉克国家博物馆。中新网3月1日电据外媒报道，座落在伊拉克首都巴格达的伊拉克国家博物馆在关闭12年后，周末时重新开放。这座博物馆自从2003年、美军在伊拉克发动反恐战争后就关闭...</p>
				</div>
			</div>
			<div class="news-list-item clear">
				<div class="news-list-item-pic"><a href="#"><img src="photoview/BC665B06733CE42D7C74750C672BA5B6.jpg.165x100.jpg" alt=""/></a></div>
				<div class="news-list-item-txt">
					<h1><a href="#">英国首相卡梅伦爱下厨钟爱烤肉 看电视剧解压</a></h1>
					<p>图为伊拉克国家博物馆。中新网3月1日电据外媒报道，座落在伊拉克首都巴格达的伊拉克国家博物馆在关闭12年后，周末时重新开放。这座博物馆自从2003年、美军在伊拉克发动反恐战争后就关闭...</p>
				</div>
			</div>
			<div class="news-list-item clear">
				<div class="news-list-item-pic"><a href="#"><img src="photoview/9EE243591C0ECDC01A328600FCFD9961.jpg.165x100.jpg" alt=""/></a></div>
				<div class="news-list-item-txt">
					<h1><a href="#">西班牙洞穴类房产供不应求 住山洞成时髦(图)</a></h1>
					<p>图为伊拉克国家博物馆。中新网3月1日电据外媒报道，座落在伊拉克首都巴格达的伊拉克国家博物馆在关闭12年后，周末时重新开放。这座博物馆自从2003年、美军在伊拉克发动反恐战争后就关闭...</p>
				</div>
			</div>
			<div class="news-list-item clear">
			...
			<div class="page-list clear">
				...
				<a href="#">16</a>
				<a href="#" class="next">&gt;</a>
				<input type="text" name="goto-page-num" id="goto-page-num" value="9"/>
			</div>
	  </div>
	</div>
