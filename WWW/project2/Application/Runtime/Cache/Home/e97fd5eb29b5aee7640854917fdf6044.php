...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  ...
  <script type="text/javascript" src="/project2/Public/js/common.js">
  </script><script type="text/javascript" src="/project2/Public/js/user.js"></script>
  <script type="text/javascript" src="/project2/Public/js/transport.js"></script>
  </head>
...
<div class="usBox_in "  style="position:relative">
    ...
    <form action="/project2/index.php/Home/User/save" method="post" name="formUser" onsubmit="return register();" style="background:none"> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div>
	  ...
	  <input name="answer" type="text" size="25" class="inputBg" maxlengt='20'/>          </td>
        ...
        <tr>
          ...
          <td align="left">
           ...
           <input name="Submit" type="submit" value="" style=" width:136px; height:35px; border:none; background:url(/project2/Public/themes/jindong/images/bnt_ur_reg.gif) no-repeat">
          </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
