...
<script type="text/javascript" src="/project2/Public/js/common.js"></script><script type="text/javascript" src="/project2/Public/themes/jindong/js/action.js"></script>
<script type="text/javascript" src="/project2/Public/themes/jindong/js/mzp-packed-me.js"></script>
...
<div class="p_w" style="clear:both; overflow:hidden"></div>
  ...
  <h3><a href="/project2/index.php/index.php">首页</a> <code>&gt;</code>  <?php echo ($navStr); ?> <?php echo ($arr["title"]); ?></h3>
</div>
...
<div class="blank"></div>      
    ...
    <div id="globalBigRight">
      ...
      <h2 class="name" style="text-align:center; font-size:16px; font-family:宋体; margin-bottom:8px; font-weight:bold; position: relative"><?php echo ($arr["title"]); ?>
      </h2>
      <div id="itemAllInfo" class="globalModule">
      <div id="goodsInfo">
      <div id="itemPic">
        <a target="_blank" href="/project2/Public/Product/<?php echo ($imageArr[0]['imagename']); ?>" onclick="window.open('gallery.php?id=4761'); return false;" id="zoom1" class="MagicZoom MagicThumb" rel="zoom-width: 550px; zoom-height: 350px; zoom-position:right">
      <img src="/project2/Public/Product/<?php echo ($imageArr[0]['imagename']); ?>" style="width:350px; height:350px;" />
	 </a>        
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
           ...
           <a  href="/project2/Public/Product/<?php echo ($v["imagename"]); ?>" rel="zoom1" 
        rev="/project2/Public/Product/<?php echo ($v["imagename"]); ?>"
        title="">
        <img src="/project2/Public/Product/<?php echo ($v["imagename"]); ?>" class="B_red" /></a>
      ...
      function clickRight() {
          ...
          <div class="b_zoom v_m"><a href="javascript:;" onclick="window.open('gallery.php?id=4761'); return false;"><img src="/project2/Public/themes/jindong/images/zoom.gif" /> 点击查看大图</a></div>
        ...
        <form action="/project2/index.php/Home/Cart/add" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
		 <ul class="line" >
               								
                        <li style="color:#999;">商品货号：P_<?php echo ($arr["id"]); ?></li>
                              <li>商品品牌：<a href="/project2/index.php/Home/Product/lister/bid/<?php echo ($arr["brandid"]); ?>" ><?php echo ($arr["bname"]); ?></a></li>
                 
                        <li>市 场 价：<span class="marketPrice">￥<?php echo ($arr["price"]); ?>元</span></li>
                        <li>美 智 价：<span class="goodsPrice" id="ECS_SHOPPRICE">￥<?php echo ($arr["userprice"]); ?>元</span></li>
           
            <li>用户评价：<img src="/project2/Public/themes/jindong/images/stars5.gif" alt="comment rank 5" /></li>
			 ...
			 <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
				<tr>
					...
					<td align="center" bgcolor="#FFFFFF"><strong>优惠价格</strong></td>
								...
								<tr>
					<td align="center" bgcolor="#FFFFFF" class="shop"><?php echo ($arr["salenum"]); ?></td>
					<td align="center" bgcolor="#FFFFFF" class="shop">￥<?php echo ($arr["saleprice"]); ?>元</td>
				</tr>
					     </table>
      </li>
      ...
      <ul>
          <li id="itemBtnList">
          	 <a href="javascript:submitForm();"><img src="/project2/Public/themes/jindong/images/btn_addcart.gif" alt="" /></a>
              <a href="javascript:collect(4761)"><img src="/project2/Public/themes/jindong/images/btn_addfav.gif" alt="" /></a><a href="user.php?act=affiliate&amp;goodsid=4761"><img src="/project2/Public/themes/jindong/images/tuijian.gif" alt="" /></a>
             <input type="hidden" name="ref" value="<?php echo ($curUrl); ?>"/>
                          </li>
          </ul>
      </form>
        </div>
     ...
     <div class="tab_box">
      ...
      <div id="com_h" class="padd_box">
        ...
        <table class="shuxin_tab" width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
        	<tr><td><?php echo ($arr["style"]); ?></td></tr>
        </table>
        </blockquote>  
        <blockquote>
    ...
    <table border="0">
      ...
      <tr>
        ...
        <td>
          ...
          <input type="image" src="/project2/Public/themes/jindong/images/button_08.jpg" />
