...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  ...
  <script type="text/javascript" src="/project2/Public/js/common.js"></script><script type="text/javascript" src="/project2/Public/js/user.js"></script><script type="text/javascript" src="/project2/Public/js/transport.js"></script></head>
...
<div class="usBox_in clearfix" style="position:relative">
  ...
  <div class="usBox_1 f_l">
   <form name="formLogin" action="/project2/index.php/Home/User/check" method="post" onSubmit="return userLogin()">
	  ...
	  <a href="user.php?act=qpassword_name" class="f3">密码问题找回密码</a>&nbsp;&nbsp;&nbsp;<a href="user.php?act=get_password" class="f3">注册邮件找回密码</a></td></tr>
      </table>
    </form>
  </div>
  <div class="usTxt" style="position:absolute; TOP:15PX; right:40PX;">
    ...
    3. 享受会员积分制度<br />
    4. 订阅本店商品信息  <br />
    <a href="user.php?act=register"><img src="/project2/Public/themes/jindong/images/bnt_ur_reg.gif" /></a>
  </div>
</div>
